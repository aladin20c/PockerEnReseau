...
public class MenuState extends GameState{
    ...
    public void analyseMessageToSend(String messageToSend) {
        if (messageToSend.matches(Request.CREATE_ROOM)) {
            ...
            if (futureRoom == null) futureRoom = new Room(0,type, numberOfPlayers, minBet, initialStack);
        }
    }
    ...
    public void analyseComingMessage(String comingMessage) {
        if (comingMessage.matches(Request.GAME_CREATED)) {
            ...
            if (length != 0) this.roomsList = new Room[length];
            ...
            this.roomsList[index - 1] = new Room(id, type, numberOfPlayers, minBet, initialStack);
