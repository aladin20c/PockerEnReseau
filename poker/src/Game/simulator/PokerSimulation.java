...
public class PokerSimulation {
	...
	public static void main(String[] args) {
		...
		pokersimulation.Hand hand = new pokersimulation.Hand(deck.dealHand(5));
		...
		for (int i = 0; i < HANDS; i++) {
			...
			deck = new Deck();
			deck.shuffle();
			hand = new pokersimulation.Hand(deck.dealHand(5));  // deal a 5 card hand from the top of the deck
