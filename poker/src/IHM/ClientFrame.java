                ...
                if(i<5){
                    ...
                    if(i==5){
                        ...
                        for (int j = 0; j < 5; j++) {
                            ...
                            /*path = "/images2/card_44.png";
                            cards[j].setIcon(new ImageIcon(this.getClass().getResource(path)));*/
                            cards[j].setBounds(1100 + (j * 15), 225, 70, 100);
                            cardsLabels.add(cards[j]);
                        }
                        for (int j = 4; j >= 0; j--) {
                            roundPanel.add(cards[j]);
